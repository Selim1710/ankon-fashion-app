...
<div class="page-wrapper">
    <main class="main">
        ...
        <div class="container">
            <div class="page-header page-header-big text-center" style="background-image: url('/website/images/contact-header-bg.jpg')">
                                ...
                                <div class="row">
                                    <div class="col-sm-5 col-xl-6">
                                        <figure class="store-media mb-2 mb-lg-0">
                                            <img src="{{ asset('website/images/contact1.jpg') }}" alt="image">
                                        </figure>
                                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="store">
                                <div class="row">
                                    <div class="col-sm-5 col-xl-6">
                                        <figure class="store-media mb-2 mb-lg-0">
                                            <img src="{{ asset('website/images/contact2.jpg') }}" alt="image">
                                        </figure>
                                    </div>
