<footer class="footer">
    <div class="cta bg-image bg-dark pt-4 pb-5 mb-0"
        style="background-image: url(/website/assets/images/demos/demo-4/bg-5.jpg);">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-sm-10 col-md-8 col-lg-6">
                    <div class="cta-heading text-center">
                        <h3 class="cta-title text-white">Get The Latest Deals</h3><!-- End .cta-title -->
                        <p class="cta-desc text-white">and receive <span class="font-weight-normal">$20 coupon</span> for
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-3">
                    <div class="widget widget-about">
                        <img src="/website/assets/images/demos/demo-4/logo-footer.png" class="footer-logo"
